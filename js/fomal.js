...
function createtime1() {
  ...
  var ascll = [
    ...
    $$ |  $$ |$$ |$$ |  $$ | $$  $$<  $$ |      $$ |       $$  /     $$  /    
    $$ |  $$ |$$ |\$$$$$$$ |$$  /\$$\ $$$$$$$$\ $$$$$$$$\ $$  /     $$  /     
    \__|  \__|\__| \____$$ |\__/  \__|\________|\________|\__/      \__/      
                  $$\   $$ |                                                  
                  \$$$$$$  |                                                  
                   \______/                                                   
...
function createtime2() {
  ...
  setTimeout(
    console.warn.bind(
      console,
      "%c ⚡ Powered by Fomalhaut🥝 %c 你正在访问Alyx2277🥝の小家",
...
function createtime() {
  ...
  // 网站诞生时间
  var grt = new Date("05/08/2023 16:38:00");
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://s1.ax1x.com/2023/05/08/p9w7Aaj.png);
    --darkmode-bg:url(https://s1.ax1x.com/2023/05/08/p9wIcWV.jpg);
    --mobileday-bg: url(https://s1.ax1x.com/2023/05/08/p9wObsP.png);
    --mobilenight-bg: url(https://s1.ax1x.com/2023/05/08/p9wOZvt.jpg);
  }`;
}
// 切换背景主函数
function changeBg(s) {
